...
@Injectable()
export class RPracticeProgressService {
  constructor(
    @InjectRepository(RPracticeProgress)
    private progressRepo: Repository<RPracticeProgress>,
  ...
  private async __create(progress: number, user: RUser, practice: Practice) {
    const entity: RPracticeProgress = new RPracticeProgress();
    entity.user = user;
  ...
  private async __update(progress: number, entity: RPracticeProgress) {
